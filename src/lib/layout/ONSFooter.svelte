<script>
	...
	export let theme = 'story_of_census';

	let primary = theme == "dark" ? "white" : "#222222";
	let secondary = theme == "dark" ? "#a8bd3a" : "#222222";
</script>

<footer style="color: {themes[theme]['text']}; background-color: {themes[theme]['pale']};">
	<div class="col-wide progress-bar-width-margin" data-analytics="footer">
		...
		<p style="color:#414042;font-weight:normal">
		    Footer text
		</p>
		<!--
